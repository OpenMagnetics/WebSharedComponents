    ...
    <div :data-cy="dataTestLabel + '-container'" class="grid ">
        <div class="col-12 grid">
            <label
                ...
                :class="combinedClass([justifyContent? 'text-left ml-0' : 'ml-3', labelBgColor, textColor, labelFontSize])"
            >
                {{toTitleCase(name)}}
            </label>
        </div>
            <div :class="classInput" class="p-checkbox-container ml-4 " v-for="[key, value] in Object.entries(options)" :key="key">
                <input
                    ...
                    :ref="key"
                    class="p-checkbox-input border-1"
                    type="checkbox"
