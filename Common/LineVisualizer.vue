...
export default {
    ...
    methods: {
        ...
        processOptions(options) {
            ...
            options.xAxis.min = limits.xAxis.min * this.linePaddings.left;
            ...
            limits.yAxis.forEach((elem, index) => {
                ...
                options.yAxis[index].min = removeTrailingZeroes(elem.min * this.linePaddings.bottom, numberDecimals);
